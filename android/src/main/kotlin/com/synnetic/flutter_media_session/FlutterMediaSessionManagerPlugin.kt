package com.synnetic.flutter_media_session
...
class FlutterMediaSessionManagerPlugin : FlutterPlugin {
    private val channelID = "com.synnetic.flutter_media_session/session"
    ...
    private fun initialize(): Boolean {
        ...
        audioManager =
                getSystemService(appBinding!!.applicationContext, AudioManager::class.java) as
                        AudioManager
